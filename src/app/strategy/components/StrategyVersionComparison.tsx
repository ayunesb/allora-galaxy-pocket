...
export function StrategyVersionComparison({ v1, v2 }: StrategyVersionComparisonProps) {
  ...
  const [older, newer] = (Number(v1.version) || 0) < (Number(v2.version) || 0) ? [v1, v2] : [v2, v1];
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          <div className="border rounded-md p-4">
            <div className="font-medium mb-2">Version {older.version || 'Unknown'}</div>
          ...
          <div className="border rounded-md p-4">
            <div className="font-medium mb-2">Version {newer.version || 'Unknown'}</div>
            <div className="text-sm text-muted-foreground">
