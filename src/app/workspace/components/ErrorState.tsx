  ...
  return (
    <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md text-center">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        {isRecursionError 
          ? "Database policy issue detected. The issue has been fixed - please refresh the page to continue."
      ...
      <div className="flex space-x-2 justify-center">
        ...
        <Button onClick={onRefresh} size="sm" variant={isRecursionError ? "default" : "outline"}>
          Refresh Page
        </Button>
      </div>
    </div>
